...
public interface MyQueue {
    ...
    //Throw Exception if the practice.queue is empty.
    ...
    //Check if the practice.queue is empty.
    public boolean isEmpty();

    //Check if the practice.queue has no more space to store new data.
    public boolean isFull();

    //Return the number of data currently stored in the practice.queue.
    public int size();
}
