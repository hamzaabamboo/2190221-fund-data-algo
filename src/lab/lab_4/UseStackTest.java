...
public class UseStackTest {
    ...
    public void testSort() throws Exception {
        // first, try to sort an empty practice.stack
        ArrayListStack s = new ArrayListStack();
        Stack result = UseStack.sort(s);
        assertTrue(result.isEmpty());

        // then try to sort a generic practice.stack
        s.push(2);
        s.push(8);
        s.push(6);
        s.push(7);
        ...
        // then try to sort another generic practice.stack, with duplicated numbers
        s.makeEmpty();
        s.push(3);
        s.push(7);
        s.push(1);
